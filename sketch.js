...
const passw = new Set(['one', 'nine', 'eight', 'three']);
let words = [
  "zero",
  "one",
  "two",
...
// if (predictedWord === "right" ){
//     console.log('Right rioght right');
// }
...
//   console.log(results);
  ...
  wordsSet.add(predictedWord);
  console.log(wordsSet);
  if (JSON.stringify([...wordsSet]) === JSON.stringify([...passw])) {
    alert('La miezul vienei va cadea o lebada');
    wordsSet = new Set();
  }
